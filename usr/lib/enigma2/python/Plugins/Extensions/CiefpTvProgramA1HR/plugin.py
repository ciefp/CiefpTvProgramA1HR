...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('/tmp/ciefp_tvprograma1hr.log', mode='w'),
...
class CiefpTvProgramA1HR(Screen):
    skin = """
        <screen name="CiefpTvProgramA1HR" position="center,center" size="1800,800" title="..:: CiefpTvProgramA1HR v1.0 ::..">
...
def Plugins(**kwargs):
    return [PluginDescriptor(
        ...
        description="A1HR EPG plugin,epgshare v1.0",
